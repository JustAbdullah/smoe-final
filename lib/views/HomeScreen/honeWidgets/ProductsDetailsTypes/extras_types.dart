...
class ExtrasWidgetsTypes extends StatefulWidget {
  const ExtrasWidgetsTypes({super.key});

  @override
  State<ExtrasWidgetsTypes> createState() => _ExtrasWidgetsTypesState();
}

class _ExtrasWidgetsTypesState extends State<ExtrasWidgetsTypes> {
  @override
  Widget build(BuildContext context) {
    HomeController homeController = Get.put(HomeController());
    homeController.fetchGetextras(homeController
        .dataProductsListByType[homeController.indexTheProductsListType.value]
        .id);
                                ...
                                builder: (ThecontrollerN) => InkWell(
                                  onTap: () {
                                    if (ThecontrollerN.chosedTheExtras.containsKey(
                                      ...
                                      ThecontrollerN.chosedTheExtras
                                          .forEach((key, value) {
